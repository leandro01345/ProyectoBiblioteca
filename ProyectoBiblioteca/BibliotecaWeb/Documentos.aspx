        ...
        <table __designer:mapid="2f" style="width: 100%;">
            ...
            <tr __designer:mapid="35">
                ...
                <td __designer:mapid="37" class="auto-style4">
                    <br />
                    <asp:GridView ID="grdDocumentos" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="grdDocumentos_SelectedIndexChanged" CssClass="table">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CANTIDAD" HeaderText="Cantidad total" HtmlEncode="False" SortExpression="CANTIDAD" />
